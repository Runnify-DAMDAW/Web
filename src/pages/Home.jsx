...
const Home = () => {
    ...
    const [searchTermInscripciones, setSearchTermInscripciones] =
        useState(false);
        ...
        if (carreras) {
            ...
            filtered = filtered
                ...
                .filter(
                    (carrera) =>
                        searchTermCategoria === "" ||
                        carrera.category.toLowerCase() ===
                            searchTermCategoria.toLowerCase()
                )
                .filter(
                    (carrera) =>
                        searchTermStatus === "" ||
                        carrera.status.toLowerCase() ===
                            searchTermStatus.toLowerCase()
                )
                .filter(
                    (carrera) =>
                        searchTermLocation === "" ||
        ...
        <div>
            ...
            >
                ...
                <div className="flex flex-col w-full sm:w-auto">
                    ...
                    <FilterInscripciones
                        onFilterChange={setSearchTermInscripciones}
                    />
                </div>
                <div className="flex flex-col w-full sm:w-auto">
                    <label className="mb-2 text-gray-800 text-left font-medium">
