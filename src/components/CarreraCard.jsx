    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`absolute left-0 bottom-0 w-full h-full bg-[#587AD7]/60 text-white p-3 flex items-center justify-center text-center
                    transition-transform duration-500 ease-in-out ${hover ? "translate-y-0 opacity-90" : "translate-y-full opacity-0"}`}>
                    <p className="text-sm sm:text-base font-bold">{carrera.description}</p>
                </div>
